            ...
            <nav className='text-right'>
                <div className='flex justify-between items-center'>
                    <h1 className='font-bold uppercase p-4 border-b border-gray-100'>
                        <a href="/" className='text-gray-400 hover:text-gray-700'>Food Ninja</a>
                    </h1>
                    <div className='px-4 cursor-pointer md:hidden' id='burger' onClick={checkClass}>
                ...
                <ul className={ hasClass ? 'text-sm mt-6 hidden md:block' : 'text-sm mt-6 block md:block'}>
            ...
            <main className='px-16 py-16 bg-gray-100 md:col-span-2'>
                    ...
                    <div>
                        ...
                        <div className='mt-8 grid lg:grid-cols-3 gap-10'>
                            ...
                            <div className='card hover:shadow-lg'>
                                <img src="img/noodles.jpg" alt="noodle" className='w-full h-32 sm:h-48 object-cover'/>
                                <div className='m-4'>
